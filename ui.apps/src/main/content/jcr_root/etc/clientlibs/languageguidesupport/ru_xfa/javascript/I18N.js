...
(function (xfalib) {
  xfalib.locale.Strings = {
    ...
    "errorFetchGeoLocation":
      "Fehler beim Abrufen der Geolocation-Informationen",
    ...
    "errorSubmittingForm":
      "Fehler beim Übermitteln des Formulars an die interne URL",
    "ok": "OK",
    "cancel": "Abbrechen",
    "yes": "Ja",
    "no": "Nein",
    ...
    "FileNameInvalid":
      "Datei(en) {0} hat/haben ungültige Zeichen in ihrem Namen. Es werden nur alphanumerische Zeichen unterstützt",
    "FileMimeTypeInvalid":
      "Datei(en) {0} ist/sind nicht unterstützte(r) Dateityp(en)",
